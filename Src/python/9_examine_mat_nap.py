...
#print(MAT_NAP_DELTA, '0.389402605178414',MAT_NAP_MNOJ, '5.202338993519127'   )
...
inputscolumn = ['Плотность, кг/м3','модуль упругости, ГПа','Количество отвердителя, м.%', \
     ...
     'Шаг нашивки', \
     'Плотность нашивки']
outputscolumns = ['Соотношение матрица-наполнитель']


dataset.columns = ['Плотность, кг/м3','модуль упругости, ГПа','Количество отвердителя, м.%', \
     'Содержание эпоксидных групп,%_2','Температура вспышки, С_2','Поверхностная плотность, г/м2', \
     'Модуль упругости при растяжении, ГПа', \
     'Прочность при растяжении, МПа', \
     'Потребление смолы, г/м2', \
