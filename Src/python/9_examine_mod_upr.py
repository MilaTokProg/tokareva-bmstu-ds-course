...
MAT_NAP_DELTA = dic_const_vost['Модуль упругости при растяжении, ГПа']['delta']
MAT_NAP_MNOJ = dic_const_vost['Модуль упругости при растяжении, ГПа']['mnozitel']
...
outputscolumns = ['Модуль упругости при растяжении, ГПа']
